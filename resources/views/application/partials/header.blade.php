<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <!--<a class="navbar-brand" href="{{ route('admin.index') }}"><img alt="logo" src="{{asset('modern-light-menu/assets/img/90x90.jpg')}}"> -->
            <!--    <span class="navbar-brand-name">GrabVisa</span>-->
            <!--</a>-->
             <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ route('application.dashboard') }}"><img alt="logo" src="{{asset('modern-light-menu/assets/img/ub.png')}}"> 
                </a>
            </div>
        </div>
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        <img src="{{asset('modern-light-menu/assets/img/90x90.jpg')}}" class="img-fluid" alt="admin-profile">
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="user-profile-dropdown">
                    <div class="">
                        <div class="dropdown-item">
                            <a class="" href="{{route('application.profile')}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> My Profile</a>
                        </div>
                        <div class="dropdown-item">

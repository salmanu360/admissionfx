...
<section class="banner-menu">
  <div class="bg-video-wrap">
    ...
    <div class="container banner-caption login-caption">
      ...
      <a href="{{route('login')}}" class="banner-btn">Logins Now</a>
    </div>
  </div>
</section>
                    ...
                    <div class="login-form register-form">
                        ...
                        <div class="row layout-top-spacing" id="cancel-row">
                            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                <form action="{{route('frontend.recruiter.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="sw-container tab-content" style="min-height: 0px;">
                                                ...
                                                <div class="fields_container" data-rows-limit="-1">
                                                    <div class="form-group field-recruitersform-company_name required">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-company_name">Company Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-email required">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-email">Email</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-website">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-website">Website</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-facebook_page">
                                                        <label style="color:#000;" for="recruitersform-facebook_page">Facebook Page Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-instagram_handle">
                                                        <label style="color:#000;" for="recruitersform-instagram_handle">Instagram Handle</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-twitter_handle">
                                                        <label style="color:#000;" for="recruitersform-twitter_handle">Twitter Handle</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-linked_url">
                                                        <label style="color:#000;" for="recruitersform-linked_url">Linkedin URL</label>
                                                ...
                                                <div class="fields_container" data-rows-limit="-1">
                                                    <div class="form-group field-main-source required">
                                                        <label style="color:#000;" for="main-source">Main Source of Students</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-owner_first_name required">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-owner_first_name">Owner's First Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-owner_last_name required">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-owner_last_name">Owner's Last Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-street_address required">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-street_address">Street Address</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-postal_code">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-postal_code">Postal Code</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-phone required">
                                                        <label style="color:#000;" for="recruitersform-phone">Phone</label>
                                                            <input type="tel" id="recruitersform-phone" class="form-control"
                                                                   name="phone" value="{{old('phone')}}"
                                                                   placeholder="(201) 555-0123">
                                                    </div>
                                                    <div class="form-group field-recruitersform-cellphone">
                                                        <label style="color:#000;" for="recruitersform-cellphone">Cellphone</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-sky_id">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-sky_id">Skype ID</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-whatsapp_id">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-whatsapp_id">Whatsapp ID</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-refer_name">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-refer_name">Has anyone from University
                                                ...
                                                <div class="fields_container" data-rows-limit="-1">
                                                    <div class="form-group field-recruitersform-begin_rec_time">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-begin_rec_time">When did you begin
                                                    ...
                                                    <div class="form-group field-recruitersform-client_service">
                                                        <label style="color:#000;" for="recruitersform-client_service">What services do you provide to your
                                                            clients?</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-rep_students required">
                                                        ...
                                                        <div id="recruitersform-rep_students">
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label style="color:#000;" class="custom-control-label" for="i0">Canadian Schools Represented</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox" id="i1" class="custom-control-input"
                                                                       name="students_from[]" value="america">
                                                                <label style="color:#000;" class="custom-control-label" for="i1">American Schools
                                                                    Represented</label>
                                                            </div>
                                                            ...
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label style="color:#000;" class="custom-control-label" for="i2">Represents Other
                                                                    Countries</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group field-recruitersform-inst_rep">
                                                        <label style="color:#000;" for="recruitersform-inst_rep">What institutions are you representing?</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-edu_org_bl">
                                                        <label style="color:#000;" for="recruitersform-edu_org_bl">What educational associations or groups does
                                                    ...
                                                    <div class="form-group field-recruit-from">
                                                        <label style="color:#000;" for="recruit-from">Where do you recruit from?</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-stu_abroad_year">
                                                        <label style="color:#000;">Approximately how many students do you send abroad per year?</label>
                                                        <div id="recruitersform-stu_abroad_year" role="radiogroup">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label style="color:#000;" class="custom-control-label" for="i3">1 - 5</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i4" class="custom-control-input"
                                                                       name="students_per_year" value="6-20">
                                                                <label style="color:#000;" class="custom-control-label" for="i4">6 - 20</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i5" class="custom-control-input"
                                                                       name="students_per_year" value="21-50">
                                                                <label style="color:#000;" class="custom-control-label" for="i5">21 - 50</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i6" class="custom-control-input"
                                                                       name="students_per_year" value="51-250">
                                                                <label style="color:#000;" class="custom-control-label" for="i6">51 - 250</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i7" class="custom-control-input"
                                                                       name="students_per_year" value="251+">
                                                                <label style="color:#000;" class="custom-control-label" for="i7">251+</label>
                                                                <div class="invalid-feedback"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group field-market-methods">
                                                        <label style="color:#000;" for="market-methods">What type of marketing methods do you undertake?</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-aver_service_fee required">
                                                        <label style="color:#000;">Average Service Fee</label>
                                                        <div id="recruitersform-aver_service_fee" role="radiogroup" aria-required="true">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label style="color:#000;" class="custom-control-label" for="i8">₹0 - ₹200</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i9" class="custom-control-input"
                                                                       name="service_fee" value="200-500">
                                                                <label style="color:#000;" class="custom-control-label" for="i9">₹200 - ₹500</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i10" class="custom-control-input"
                                                                       name="service_fee" value="500-1000">
                                                                <label style="color:#000;" class="custom-control-label" for="i10">₹500 - ₹1000</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i11" class="custom-control-input"
                                                                       name="service_fee" value="1000-2500">
                                                                <label style="color:#000;" class="custom-control-label" for="i11">₹1000 - ₹2500</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i12" class="custom-control-input"
                                                                       name="service_fee" value="2500+">
                                                                <label style="color:#000;" class="custom-control-label" for="i12">₹2500+</label>
                                                                <div class="invalid-feedback"></div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group field-recruitersform-refer_stu_univer">
                                                        <label style="color:#000;">Please provide an estimate of the number of students you will refer to
                                                        ...
                                                        <div id="recruitersform-refer_stu_univer" role="radiogroup">
                                                            <div class="custom-control custom-radio">
                                                                ...
                                                                <label style="color:#000;" class="custom-control-label" for="i13">1 - 5</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i14" class="custom-control-input"
                                                                       name="refer_student_bureau" value="6-20">
                                                                <label style="color:#000;" class="custom-control-label" for="i14">6 - 20</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i15" class="custom-control-input"
                                                                       name="refer_student_bureau" value="21-50">
                                                                <label style="color:#000;" class="custom-control-label" for="i15">21 - 50</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i16" class="custom-control-input"
                                                                       name="refer_student_bureau" value="51-250">
                                                                <label style="color:#000;" class="custom-control-label" for="i16">51 - 250</label>
                                                            </div>
                        
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="i17" class="custom-control-input"
                                                                       name="refer_student_bureau" value="251+">
                                                                <label style="color:#000;" class="custom-control-label" for="i17">251+</label>
                                                            </div>
                                                        </div>
                        
                                                    </div>
                                                    <div class="form-group field-recruitersform-add_comment">
                                                        <label style="color:#000;" for="recruitersform-add_comment">Additional Comments</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-refrence_name">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-refrence_name">Reference Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-ref_stu_name">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-ref_stu_name">Reference Institution Name</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-ref_business_email">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-ref_business_email">Reference Institution Email</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-ref_phone">
                                                        <label style="color:#000;" for="recruitersform-ref_phone">Reference Institution Phone</label>
                                                            <input type="text" id="recruitersform-ref_phone" class="form-control"
                                                    ...
                                                    <div class="form-group field-recruitersform-ref_website">
                                                        <label style="color:#000;" class="form-label" for="recruitersform-ref_website">Reference Website</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-comp_logo">
                                                        <label style="color:#000;" for="recruitersform-comp_logo">Company Logo</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-bus_certificate">
                                                        <label style="color:#000;" for="recruitersform-bus_certificate">Business Certificate</label>
                                                    ...
                                                    <div class="form-group field-recruitersform-confirmation">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label style="color:#000;" class="custom-control-label" for="recruitersform-confirmation">I declare
                                                    ...
                                                    <div class="form-group field-recruitersform-acceptance required">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" id="recruitersform-acceptance"
                                                                    ...
                                                                    checked="checked" >
                                                            <label style="color:#000;" class="custom-control-label" for="recruitersform-acceptance">I have read

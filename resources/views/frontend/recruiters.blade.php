...
<section class="banner-menu mob-inner-height">
  <div class="bg-video-wrap">
    ...
    <div class="container banner-caption mob-inner-caption">
      ...
      <a href="{{route('frontend.recruiter.index')}}" class="banner-btn">Become a Recruitment Partner</a>
    </div>
  </div>
</section>
...
<section class="about-ub mt-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-5">
        <img src="{{asset('university/images/dashboard-img.jpg')}}" class="w-100" alt="dashboard-img">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <a href="{{route('frontend.recruiter.index')}}" class="maximise-btn">Register with us & <span>Start Earning</span></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row lets-started-row">
      <div class="col-md-4">
        <div class="easy-box h-100">
          <div class="easy-img-box">                 
            <img src="{{asset('university/images/easy-img-1.jpg')}}" class="w-100" alt="easy-img">
          </div>
          <div class="easy-text">
      ...
      <div class="col-md-4">
        <div class="easy-box h-100">
          <div class="easy-img-box">
            <img src="{{asset('university/images/easy-img-2.jpg')}}" class="w-100" alt="easy-img">
          </div>
          <div class="easy-text">
      ...
      <div class="col-md-4">
        <div class="easy-box h-100">
          <div class="easy-img-box">
            <img src="{{asset('university/images/easy-img-3.jpg')}}" class="w-100" alt="easy-img">
          </div>
          <div class="easy-text">

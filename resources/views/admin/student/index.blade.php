...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        ...
        <a href="{{route('student.uploadexcel')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Upload Excel</button></a>
...
<div class="modal fade" id="eligibleNotes{{ $student->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                   <form action="{{route('student.addNotes')}}" method="POST">
                    @csrf
                    @method("POST")
...
<div class="modal fade" id="not-eligibleNotes{{ $student->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                   <form action="{{route('studentNot.addNotes')}}" method="POST">
                    @csrf
                    @method("POST")
                    <input type="hidden" name="id" value="{{ $student->id }}">
                    <div class="form-group">

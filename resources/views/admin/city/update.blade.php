    ...
    <div class="page-header">
        ...
        <div class="dropdown filter custom-dropdown-icon">
            <a href="{{route('cities.index')}}">
                <button class="btn btn-success"><i class="fa-solid fa-eye"></i> View Cities</button>
            </a>
        </div>
    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control mb-4"
                                                           id="degree2" value="{{$city->name}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="degree2">Country Name</label>
                                                    <select name="state_id" class="form-select form-control digits"
                                                            id="exampleFormControlSelect9">
                                                        <option value="">Select State</option>
                                                        @foreach($states as $state)
                                                            <option <?php if($state->id==$city->state_id){echo 'selected';} ?> value="{{$state->id}}">{{$state->name}}</option>
                                                        @endforeach
                                                    ...
                                                    <div class="n-chk">
                                                        <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                                            ...
                                                            <span class="new-control-indicator"></span><span
                                                                    class="new-chk-content">Active</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>

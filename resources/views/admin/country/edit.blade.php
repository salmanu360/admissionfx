...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('country.index')}}"><button class="btn btn-success"><i class="fa-solid fa-eye"></i> View Country</button></a>
    </div>
</div>
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                ...
                <br>
                <form action="{{route('country.updateCountry', $myCountry->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="info">
                        <div class="row">

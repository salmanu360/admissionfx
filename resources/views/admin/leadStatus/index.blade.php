...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a><button class="btn btn-success" data-toggle="modal"data-target="#gradingModel"><i class="fa-solid fa-square-plus"></i> Add Lead Status</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-centers">
                                ...
                                data-toggle="modal"
                                data-target="#ediGradingModal{{$lead->id}}"
                                data-toggle="tooltip" data-placement="top"
                                title="edit grading">
                                <i class="fa fa-edit" aria-hidden="true"></i>
                            </button>
                            <a class="text text-danger btn-sm deleteRecord" style="color: white" href="javascript:void(0);" rel="{{ $lead->id }}" rel1="delete_recruiter" onclick="deleterecord('{{$lead->id}}','lead/destroy');">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="example-Modal3"> Add Lead Status</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                   <form action="{{route('leadStatus.create')}}" method="POST">
                    @csrf
                    @method("POST")
...
<script>
    ...
    getDetail = function (id)
    {
        ...
        $.ajax({
            url: SITEURL + "/admin/lead/getDetail/" + id,
            type: 'GET',
    ...
    getDocument = function (id)
    {
        ...
        $.ajax({
            url: SITEURL + "/admin/lead/getDocument/" + id,
            type: 'GET',
            success: function (response)
            {
                $('#recruiterModal').modal('toggle');

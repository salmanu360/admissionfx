...
<head>
    ...
    <title>University Bureau Admin Login</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="" style="font-size: 28px;">Log In to <a href="/"><span class="brand-name">University Bureau</span></a></h1>
                        <!-- Session Status -->
                        ...
                        <form method="POST" action="{{ route('admin.login') }}" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="identity" type="text" class="form-control" placeholder="Email" value="{{ old('email') }}" required autofocus />
                                </div>

    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                ...
                <br>
                <form action="{{route('package.updatePackage', $myPackage->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="info">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="p_name" class="form-control mb-4" id="degree2" value="{{$myPackage->p_name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="plan_type" id="" class="form-control">
                                                            <option value="{{$myPackage->plan_type}}">{{$myPackage->plan_type}}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="no_of_days" class="form-control mb-4" id="degree4" value="{{$myPackage->no_of_days}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="visa_type" id="" class="form-control">
                                                            <option value="{{$myPackage->visa_type}}">{{ucfirst($myPackage->visa_type)}}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="processing_time" id="" class="form-control">
                                                            <option value="{{$myPackage->processing_time}}">{{ucfirst($myPackage->processing_time)}}</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="stay" value="{{$myPackage->stay}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="degree4">Validity</label>
                                                        <input class="form-control" type="text" name="validity" value="{{$myPackage->validity}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="country_to" id="" class="form-control">
                                                            <option value="{{$myPackage->slug.','.$myPackage->country_to}}">{{ucfirst($myPackage->country_to)}}</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="insurance" id="" class="form-control">
                                                            <option value="{{$myPackage->insurance}}">{{ucfirst($myPackage->insurance)}}</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="entry_type" id="" class="form-control">
                                                            <option value="{{$myPackage->entry_type}}">{{ucfirst($myPackage->entry_type)}}</option>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="price" value="{{$myPackage->price}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="" cols="30" rows="5">{{$myPackage->description}}</textarea>
                                            </div>
                                        </div>

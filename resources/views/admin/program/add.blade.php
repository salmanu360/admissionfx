...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('program.index')}}"><button class="btn btn-success"><i class="fa-solid fa-eye"></i> View Programs</button></a>
    </div>
</div>
                            ...
                            <div class="col-md-11 mx-auto">
                                ...
                                <div class="work-section">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary">Add Course Program</button>
                                            </div>
                                        </div>

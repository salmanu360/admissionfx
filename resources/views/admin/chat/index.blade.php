...
@section('content')
<link rel="stylesheet" href="{{asset('modern-light-menu/assets/css/apps/mailing-chat.css')}}">
...
<script src="{{asset('modern-light-menu/assets/js/apps/mailbox-chat.js')}}"></script>

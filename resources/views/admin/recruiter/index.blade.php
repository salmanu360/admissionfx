...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        ...
        <a href="{{route('recruiter.uploadexcel')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Upload Excel</button></a>
                ...
                <table class="multi-table table table-striped table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a style="color:blue" href="{{route('recruiter.getDetail', $recruiter->id)}}"> {{$recruiter->company_name}}</a></td>
                            <td><a style="color:blue" href="{{route('recruiter.getDetail', $recruiter->id)}}"> {{$recruiter->first_name}} {{$recruiter->last_name}}</a></td>
                            ...
                            <td>
                                @if($recruiter->status == 1)
                                    <a onClick="return confirm('Are you sure you want to Disapprove this recruiter..?)" class="badge bg-success updaterecruiterStatus btn-rounded" style="color: #fff;" href="{{route('recruiter.status',['id'=>$recruiter->id,'status'=>0])}}" id="recruiter-{{$recruiter->id}}" recruiter_id="{{$recruiter->id}}">approve</a>
                                @else
                                <a onClick="return confirm('Are you sure you want to approve this recruiter..?)" class="badge bg-danger updaterecruiterStatus btn-rounded" style="color: #fff;" href="{{route('recruiter.status',['id'=>$recruiter->id,'status'=>1])}}" id="recruiter-{{$recruiter->id}}" recruiter_id="{{$recruiter->id}}">disaprove</a>
                                @endif
                            </td>
                            <td class="text-centers">
                                ...
                                <a href="#" data-toggle="modal" data-target="#appTeamModel{{ $recruiter->id }}"> <i class="fa fa-key" aria-hidden="true"></i> </a>
                            ...
                            <button class="btn btn-success" data-toggle="modal"data-target="#addNotes{{ $recruiter->id }}" title="Add Notes">Add Notes</button>
...
<div class="modal fade" id="addNotes{{ $recruiter->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                   <form action="{{route('recruiter.addNotes')}}" method="POST">
                    @csrf
                    @method("POST")

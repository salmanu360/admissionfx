                           ...
                           @foreach($packages as $offer)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route('package.view.insurance_booking', $offer->id)}}"><button class="btn btn-info btn-sm"> <i class="fa fa-eye"></i></button></a>
                                    <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:void(0);" rel="{{ $offer->id }}" rel1="delete_offers" onclick="deleterecord('{{$offer->id}}','delete_insurance_booking');">

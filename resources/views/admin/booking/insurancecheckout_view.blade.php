        ...
        <div class="row">
            <div class="col-md-12">
				...
				<div class="row review-box">
					<div class="col-md-3">
						<p><b>Visa Type</b></p>
						<p>{{$checkout->insurances->plan_name}}</p>
					</div>
					<div class="col-md-3">
						<p><b>Coverage</b></p>
						<p>{{$checkout->insurances->coverage}}</p>
					</div>
					<div class="col-md-3">
						<p><b>{{$checkout->insurances->age_range1}}</b></p>
						<p>{{$checkout->insurances->price1}}</p>
					</div>
					<div class="col-md-3">
						<p><b>{{$checkout->insurances->age_range2}}</b></p>
						<p>{{$checkout->insurances->price2}}</p>
					</div>
					<div class="col-md-3">
						<p><b>{{$checkout->insurances->age_range3}}</b></p>
						<p>{{$checkout->insurances->price3}}</p>
					</div>
					<div class="col-md-3">
						<p><b>Destination</b></p>
						<p>{{$checkout->insurances->destination}}</p>
					</div>
				</div>

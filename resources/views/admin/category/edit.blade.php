    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                ...
                <br>
                <form action="{{route('category.updateCategory', $myCategory->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="info">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control mb-4" id="degree2" value="{{$myCategory->name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <img style="width:50px;" src="{{asset('uploads/category/'.$myCategory->image)}}" id="one">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" id="" cols="30" rows="5">{{$myCategory->description}}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <div class="n-chk">
                                                    <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                                                      <input type="checkbox" class="new-control-input" name="status" @if($myCategory->status == 1) checked @endif>

    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                ...
                <br>
                <form action="{{ route('updateInsurance') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $myPackage->id }}">
                    <div class="info">
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="plan_name" class="form-control mb-4" id="degree2" value="{{ $myPackage->plan_name }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="coverage" value="{{ $myPackage->coverage }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="destination" id="" class="form-control">
                                                            @foreach($countries as $country)
                                                             @if($myPackage->destination == $country->name)
                                                            <option selected value="{{$myPackage->destination}}">{{$myPackage->destination}}</option>
                                                            @else
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="price1" value="{{ $myPackage->price1 }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="price2" value="{{ $myPackage->price2 }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <input type="number" class="form-control" name="price3" value="{{ $myPackage->price3 }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

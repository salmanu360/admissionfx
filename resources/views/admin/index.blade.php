...
<div class="row layout-top-spacing">
            ...
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        ...
                        <p class=""><a href="{{route('course.index')}}">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            {{ $totalCourse }}
            ...
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        ...
                        <p class=""><a href="{{route('college.index')}}">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            {{ $totalCollege }}
            ...
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        ...
                        <p class=""><a href="{{route('recruiter.index')}}">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            {{ $totalrecruiter }}
            ...
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        ...
                        <p class=""><a href="{{route('student.index')}}">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            {{ $totalStudent }}
    ...
    @php  $student_lead_count=\App\Models\Student::where('lead_status', $lead->id)->count();
    @endphp
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">{{$lead->name}}</h6>
                        <p class=""><a href="{{route('student.leadstudent', $lead->id)}}">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            {{$student_lead_count}}
                ...
                <div class="progress" style="margin-top: 10px !important;">
                    <div class="progress-bar bg-gradient-secondary" role="progressbar" style="width: {{$student_lead_count}}%" aria-valuenow="57" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!--<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Submitted</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Rejected</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Visa In Process</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Visa Submitted</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Visa Applied</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Refund Request</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Refund Processed</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Refund Received</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value" style="font-size: 16px;">Deposit Paid</h6>
                        <p class=""><a href="">View</a></p>
                    </div>
                    <div class="">
                        <div class="w-icon">

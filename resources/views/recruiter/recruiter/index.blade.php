...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('rec.create')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Add recruiter</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-centers">
                                ...
                                <a href="{{route('rec.create')}}"><i class="fa-solid fa-square-plus"></i></a>
                               {{-- <a href=""><i class="fa-solid fa-square-plus"></i></a>--}}
                                <a href="{{route('rec.edit', $recruiter->id)}}"><i class="far fa-edit"></i></a>
                                <a class="text text-danger btn-sm deleteRecord" style="color: white" href="javascript:void(0);" rel="{{ $recruiter->id }}" rel1="delete_recruiter" onclick="deleterecord('{{$recruiter->id}}','destroy');">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('rec.password', $recruiter->id)}}" method="POST"
...
<script>
    ...
    if (result.isConfirmed) {
        window.location.href = SITEURL + "/recruiter/" + deleteFunction + "/" + id;
    }
    })

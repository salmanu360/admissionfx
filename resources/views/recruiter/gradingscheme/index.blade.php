                ...
                <table class="multi-table table table-striped table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a class="text text-danger btn-sm deleteRecord" style="color: white" href="javascript:void(0);" rel="{{ $grading->id }}" rel1="delete_recruiter" onclick="deleterecord('{{$grading->id}}','destroy');">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                   <form action="{{route('grad.create')}}" method="POST">
                    @csrf
                    @method("POST")
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
               <form action="{{route('grad.update', $grading->id)}}" method="POST">
                @csrf
                @method("PUT")
                <div class="form-group">
                    <label for="recipient-name" class="form-control-label">Name :</label>
...
<script>
    ...
    if (result.isConfirmed) {
        window.location.href = SITEURL + "/grading/" + deleteFunction + "/" + id;
    }
    })
    ...
    getDetail = function (id)
    {
        ...
        $.ajax({
            url: SITEURL + "/grading/getDetail/" + id,
            type: 'GET',
    ...
    getDocument = function (id)
    {
        ...
        $.ajax({
            url: SITEURL + "/grading/getDocument/" + id,
            type: 'GET',
            success: function (response)
            {
                $('#recruiterModal').modal('toggle');

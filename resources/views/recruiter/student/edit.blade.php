...
@section('content')
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
            ...
            <form action="{{ route('std.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="country_citizenship"
                                                           ...
                                                           value="{{ old('country_citizenship', $student->country_citizenship) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                    ...
                                    <section style="padding: 1.5% !important;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="country_edu" class="form-control" id="">
                                                        @foreach ($countries as $country)
                                                            <option value="{{$country->name}}" {{$student->country_edu == $country->name ? 'selected' : ''}}>{{$country->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="high_level_edu" class="form-control" id="">
                                                        @foreach ($levels as $level)
                                                            <option value="{{$level->name}}" {{$student->high_level_edu == $level->name ? 'selected' : ''}}>{{$level->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="grading_scheme" class="form-control" id="">
                                                        @foreach ($gradings as $grading)
                                                            <option value="{{$grading->name}}" {{$student->grading_scheme == $grading->name ? 'selected' : ''}}>{{$grading->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <button type="button" class="btn btn-outline-success add_field_button">
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                ...
                                                var selectedList = $('.selected-options');
                                                
                                                $(addButton).click(function() {
                                        
                                                    var countryEdu = $('select[name="country_edu[]"]').val();
                                                    var highLevelEdu = $('select[name="high_level_edu[]"]').val();
                                                    var gradingScheme = $('select[name="grading_scheme[]"]').val();
                                                    
                                                    var listItem = '<li>' + countryEdu + highLevelEdu + ' - ' + gradingScheme + '</li>';
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="country_institute"
                                                           class="form-control"
                                                           id="country_institute"

                                                           value="{{ old('country_institute', $student->country_institute) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="level_education"
                                                           class="form-control"
                                                           id="level_education"

                                                           value="{{ old('level_education', $student->level_education) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">

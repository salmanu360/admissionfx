...
@section('content')
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
            ...
            <form action="{{ route('std.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="emergency_contact_email"
                                                           ...
                                                           value="{{ old('emergency_contact_email') }}" autofocus>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">

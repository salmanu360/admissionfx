        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu active">
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                        <li>
                            <a href="{{ route('colg.index') }}">College</a>
                        </li>
                        <li>
                            <a href="{{ route('rec.cors_colg.index') }}">Filter</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                        <li>
                            <a href="{{ route('cors.index') }}">Course</a>
                        </li>
                        <li>
                            <a href="{{ route('rec.intake.index') }}">Filter</a>
                        </li>
                    </ul>
                </li>
                ...
                <!--    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">-->
                <!--        <li>-->
                <!--            <a href="{{ route('cors_colg.index') }}">College & Course</a>-->
                <!--        </li>-->
                <!--        <li>-->
                <!--            <a href="{{ route('intake.index') }}">Intake</a>-->
                <!--        </li>-->
                <!--    </ul>-->
                <!--</li>-->
            ...
            <li class="menu single-menu active">
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                        <li><a href="{{ route('college.index') }}">Collage</a></li>
                        <li><a target="_blank" href="{{asset('uploads/excel_template/college.csv')}}">Download College excel </a></li>
                    </ul>
                </li>
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                        ...
                        <li><a target="_blank" href="{{asset('uploads/excel_template/course.csv')}}">Download Course excel </a></li>
                    </ul>
                </li>

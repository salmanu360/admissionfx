...
<head>
    ...
    <title>University Bureau Recruiter - Dashboard </title>
    ...
    <style>
        ...
        .study-destinaton-section {
            ...
            background-image: linear-gradient(135deg, #f0393a 13%, #0f6888 100%);
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="main-container" id="container">
        ...
        <!--  BEGIN TOPBAR  -->
        @include('recruiter.partials.navigation')
        <!--  END TOPBAR  -->

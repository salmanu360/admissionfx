...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('students.create')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Add Student</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!--<td class="text-centers">
                                ...
                                <a href="{{route('students.create')}}"><i class="fa-solid fa-square-plus"></i></a>

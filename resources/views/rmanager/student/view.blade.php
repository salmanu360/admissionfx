...
@section('content')
    ...
    @if (File::exists('uploads/student/passport/'.$student->passport) & !is_null($student->passport))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->passport, 'passport'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    ...
    @if (File::exists('uploads/student/ielts/'.$student->ielts) & !is_null($student->ielts))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->ielts, 'ielts'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    ...
    @if (File::exists('uploads/student/grade_10/'.$student->grade_10) & !is_null($student->grade_10))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->grade_10, 'grade_10'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    ...
    @if (File::exists('uploads/student/grade_12/'.$student->grade_12) & !is_null($student->grade_12))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->grade_12, 'grade_12'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    ...
    @if (File::exists('uploads/student/bachelor_mark_sheet/'.$student->bachelor_mark_sheet) & !is_null($student->bachelor_mark_sheet))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->bachelor_mark_sheet, 'bachelor_mark_sheet'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    @if (File::exists('uploads/student/bachelor_certificate/'.$student->bachelor_certificate) & !is_null($student->bachelor_certificate))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->bachelor_certificate, 'bachelor_certificate'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    ...
    @if (File::exists('uploads/student/master_certificate/'.$student->master_certificate) & !is_null($student->master_certificate))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->master_certificate, 'master_certificate'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    @if (File::exists('uploads/student/lors/'.$student->lors) & !is_null($student->lors))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->lors, 'lors'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    @if (File::exists('uploads/student/resume/'.$student->resume) & !is_null($student->resume))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->resume, 'resume'] )}}" class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif
    @if (File::exists('uploads/student/work_experience/'.$student->work_experience) & !is_null($student->work_experience))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->work_experience, 'work_experience'] )}}"
    ...
    @if (File::exists('uploads/student/other_certificate/'.$student->other_certificate) & !is_null($student->other_certificate))
        <div class="row mt-2">
            ...
            <div class="col-md-4">
                <a href="{{route('student.downloadFile', [$student->other_certificate, 'other_certificate'] )}}"
                   class="btn btn-primary">Download</a>
            </div>
        </div>
    @endif

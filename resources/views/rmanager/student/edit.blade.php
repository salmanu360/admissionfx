                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="country_edu"
                                                           class="form-control"
                                                           id="country_edu"
                                                           value="{{ old('country_edu', $student->country_edu) }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="high_level_edu"
                                                           class="form-control"
                                                           id="high_level_edu"

                                                           value="{{ old('high_level_edu', $student->high_level_edu) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="grading_scheme"
                                                           ...
                                                           value="{{ old('grading_scheme', $student->grading_scheme) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="custom-file mb-4">
                                                        <input type="file" name="other_certificate"
                                                               class="custom-file-input"

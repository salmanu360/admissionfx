...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('colleges.create')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Add College</button></a>
         <a href="{{route('colleges.uploadexcel')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Upload Excel</button></a>
            ...
            <div class="table-responsive mb-4 mt-4">
                ...
                <table class="multi-table table table-striped table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$loop->index + 1}}</td>
                           <td><a style="color:blue" href="{{route('colleges.getDetail', $college->id)}}">{{$college->name}}</a></td>
                            <td>{{$college->slug}}</td>
                            ...
                            <td class="text-centers">
                                ...
                                <a href="{{route('colleges.create')}}"><i class="fa-solid fa-square-plus"></i></a>
                                <a href="{{route('editColleges', $college->id)}}"><i class="far fa-edit"></i></a>
                                <a class="text text-danger btn-sm deleteRecord" style="color: white" href="javascript:void(0);" rel="{{ $college->id }}" rel1="delete_college" onclick="deleterecord('{{$college->id}}','rm/college/delete_college');">

...
<div class="page-header">
    ...
    <div class="dropdown filter custom-dropdown-icon">
        <a href="{{route('countries.addCountry')}}"><button class="btn btn-success"><i class="fa-solid fa-square-plus"></i> Add Country</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-centers">
                                ...
                                <a href="{{route('countries.editCountry', $country->id)}}"><i class="far fa-edit"></i></a>
...
<script>
    ...
    if (result.isConfirmed) {
        window.location.href = SITEURL + "/rm/" + deleteFunction + "/" + id;
    }
    })

...
class RecruiterController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       /* ===mail to admin===*/
        $mailData = [
          ...
          <p>Email: '.$Recruiter->company_name.'</p>
    ...
    public function changePassword(Request $request, $id){
        ...
        $recruiterpassword = RecruiterPassword::where('user_id',$recruiter->user_id)->update([
    ...
    public function edit($id)
    {
        ...
        return view('admin.recruiter.edit', compact('recruiter', 'recruiterMarketings'));
    }
    ...
    {
        $recruiter = Recruiter::find($id);
        return view('admin.recruiter.view', compact('recruiter'));
    ...
    public function getDocument($id)
    {
        ...
        return view('admin.recruiter.modal.recruiterDocumentModal', compact('recruiter'));
    }
    ...
    {
        $statusupdate = Recruiter::where('id', $id)->first();
        $RecruiterPassword = RecruiterPassword::where('user_id', $statusupdate->user_id)->first();
        
        if(!empty($RecruiterPassword)){
           $pass= $RecruiterPassword->recruiter_password;
        }else{
            $pass='';
        }
        
        Recruiter::where('id', $id)->update(['status'=>$status]);
        ...
        $mailData = [
          ...
          One Recruiter ('.$statusupdate->first_name. ' '.$statusupdate->last_name.') has been '.$checkstatus.' by admin. Thanks',
          ];
       ...
       if($status ==1){
        ...
        Mail::to($statusupdate->email)->send(new recruitermail($mailData));
       }else{
       ...
       Session::flash('success_message', 'Recruiter has been successfully '.$checkstatus);
    ...
    {
        return view('admin.recruiter.uploadexcel');
    }

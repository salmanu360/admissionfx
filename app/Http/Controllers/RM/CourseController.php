...
class CourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('rmanager.course.index', compact('courses'));
    }

    public function create()
    {
        $colleges = College::all();
        return view('rmanager.course.add', compact('colleges'));
    }
    ...
    public function edit($id)
    {
        ...
        $colleges = College::all();
        return view('rmanager.course.edit', compact('colleges', 'course'));
    }
    ...
    {
        return view('rmanager.course.uploadexcel');
    }
